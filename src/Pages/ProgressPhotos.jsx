                ...
                {selectedPhoto && (
                    <div className="mt-6 p-4 bg-white rounded-lg shadow-md">
                        ...
                        <p>
                            ...
                            {selectedPhoto.leafColor}
                        </p>
                        <p>
                            <strong>Leaf Density:</strong>{" "}
                            {selectedPhoto.leafDensity}
                        </p>
                        <p>
                            <strong>Trunk Diameter:</strong>{" "}
                            {selectedPhoto.trunkDiameter}
                        </p>
                        <p>
                            <strong>Canopy Diameter:</strong>{" "}
                            {selectedPhoto.canopyDiameter}
                        </p>
                        <p>
                            <strong>Growth Rate:</strong>{" "}
                            {selectedPhoto.growthRate}
                        </p>
                        <p>
